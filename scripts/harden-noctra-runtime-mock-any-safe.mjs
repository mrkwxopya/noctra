...
const reportPath = "noctra-runtime-mock-any-safe-report.md";
...
const runtimeContent = `import { createElement, forwardRef, type ElementType, type ReactNode } from "react";
...
const report = [
  "# Noctra Runtime Mock Any-Safe Report",
  "",
  ...
  "## Applied",
  "",
  "- Regenerated NoctraRuntimeMock with any-safe DOM props.",
  "- Kept all required card slot exports.",
  "- Kept Noctra utility type aliases.",
  "- Forced createElement children to any-safe nodes.",
  "- Preserved docs-only preview runtime behavior."
].join("\n");

writeFileSync(reportPath, `${report}\n`, "utf8");

console.log(`Noctra runtime mock any-safe patch completed. Problems: ${problems.length}. Report: ${reportPath}`);

if (problems.length > 0) {
  console.error(report);
  throw new Error("Noctra runtime mock any-safe patch failed.");
}
