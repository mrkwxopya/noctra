...
const target = "apps/docs/src/data/interactiveDemoPresets.ts";
...
const content = `export type InteractiveDemoPreset = Record<string, any>;
...
export const removedInteractiveDemoComponents = new Set(${JSON.stringify(removedDateTimeNames, null, 2)});
