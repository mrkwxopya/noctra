...
patchText("packages/react/src/components/index.ts", 'export * from "./TransferList";', 'export * from "./Tree";');
patchText("packages/tokens/src/index.ts", 'export * from "./components/transfer-list";', 'export * from "./components/tree";');

let css = readText("packages/styles/src/components.css");
if (!css.includes('transfer-list.css')) {
  css = css.replace('@import "./components/tree.css";', '@import "./components/tree.css";@import "./components/transfer-list.css";');
