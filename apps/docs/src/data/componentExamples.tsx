  ...
  Button: [
    {
      ...
      code: `import { Button, Group } from "@noctra/react";
  ...
  Card: [
    {
      ...
      code: `import { Card, CardBody, CardDescription, CardHeader, CardTitle } from "@noctra/react";
...
export function Example() {
  return (
    ...
    },
    {
      ...
      code: `import { Card, CardBody, Group, Stack } from "@noctra/react";
  ...
  Paper: [
    {
      ...
      code: `import { Paper, Stack, Divider } from "@noctra/react";
  ...
  Stack: [
    {
      ...
      code: `import { Stack, Card } from "@noctra/react";
  ...
  Grid: [
    {
      ...
      code: `import { Grid, Card } from "@noctra/react";
  ...
  Flex: [
    {
      ...
      code: `import { Box, Flex } from "@noctra/react";
  ...
  Box: [
    {
      ...
      code: `import { Box } from "@noctra/react";
  ...
  Divider: [
    {
      ...
      code: `import { Divider, Stack } from "@noctra/react";
  ...
  Spacer: [
    {
      ...
      code: `import { Group, Spacer, Box } from "@noctra/react";
  ...
  Section: [
    {
      ...
      code: `import { Card, Grid, Section } from "@noctra/react";
  ...
  Alert: [
    {
      ...
      code: `import { Alert } from "@noctra/react";
  ...
  Badge: [
    {
      ...
      code: `import { Badge, Group } from "@noctra/react";
  ...
  TextInput: [
    {
      ...
      code: `import { TextInput, Stack } from "@noctra/react";
  ...
  Textarea: [
    {
      ...
      code: `import { Textarea } from "@noctra/react";
  ...
  Select: [
    {
      ...
      code: `import { Select } from "@noctra/react";
  ...
  Checkbox: [
    {
      ...
      code: `import { Checkbox, Stack } from "@noctra/react";
  ...
  Switch: [
    {
      ...
      code: `import { Switch, Stack } from "@noctra/react";
  ...
  Radio: [
    {
      ...
      code: `import { Radio, Stack } from "@noctra/react";
  ...
  Modal: [
    {
      ...
      code: `import { Button, Modal } from "@noctra/react";
  ...
  Drawer: [
    {
      ...
      code: `import { Drawer } from "@noctra/react";
  ...
  Tabs: [
    {
      ...
      code: `import { Tabs } from "@noctra/react";
  ...
  Table: [
    {
      ...
      code: `import { Table } from "@noctra/react";
  ...
  Accordion: [
    {
      ...
      code: `import { Accordion } from "@noctra/react";
  ...
  Tooltip: [
    {
      ...
      code: `import { Button, Tooltip } from "@noctra/react";
  ...
  Progress: [
    {
      ...
      code: `import { Progress } from "@noctra/react";
  ...
  Skeleton: [
    {
      ...
      code: `import { Skeleton, Stack } from "@noctra/react";
  ...
  CodeBlock: [
    {
      ...
      code: `import { CodeBlock } from "@noctra/react";

export function Example() {
  return <CodeBlock code={'import { Button } from "@noctra/react";'} />;
}`,
      preview: (
        <PreviewShell title="Code preview">
          <pre className="nd-code"><code>{`import { Button } from "@noctra/react";`}</code></pre>
        </PreviewShell>
      )
    }
  ]
...
export function getFallbackExample(componentName: string): ComponentExample {
  return {
    ...
    code: `import { ${componentName} } from "@noctra/react";
