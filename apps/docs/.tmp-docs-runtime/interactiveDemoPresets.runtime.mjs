...
export const interactiveDemoPresets = {
    Input: {
        title: "Input",
...
export function isRemovedInteractiveDemoComponent(component) {
...
export function hasInteractiveDemoPreset(component) {
    const componentName = typeof component === "string" ? component : component.name;
    return Object.prototype.hasOwnProperty.call(interactiveDemoPresets, componentName);
}
export function getInteractiveDemoPreset(component) {
    const componentName = typeof component === "string" ? component : component.name;
    if (isRemovedInteractiveDemoComponent(componentName))
        return undefined;
    return interactiveDemoPresets[componentName];
}
export function getComponentInteractiveDemoPreset(componentName) {
    return getInteractiveDemoPreset(componentName);
}
export function getComponentDemoPreset(componentName) {
    return getInteractiveDemoPreset(componentName);
}
export function getSafeInteractiveDemoPreset(componentName) {
    return getInteractiveDemoPreset(componentName);
}
function getDemoComponentName(component) {
    return typeof component === "string" ? component : component.name;
}
function getDemoComponentProps(component) {
...
function shouldRenderCodeProp(key, value) {
...
function formatCodeProp(key, value) {
    if (value === true)
        return key;
    if (value === false)
        return `${key}={false}`;
...
function hasRuntimeProp(component, propName) {
...
export function componentSupports(component, propName) {
    return hasRuntimeProp(component, propName);
}
export function buildInteractiveDemoProps(component, state = {}) {
...
export function getInteractiveDemoCode(component, state = {}) {
    const componentName = getDemoComponentName(component);
    const preset = getInteractiveDemoPreset(componentName);
...
export function getComponentInteractiveDemoCode(component, state = {}) {
    return getInteractiveDemoCode(component, state);
}
export function buildComponentInteractiveDemoProps(component, state = {}) {
