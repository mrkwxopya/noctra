...
import { Button, Card, Stack } from "../components/docs-system/NoctraRuntimeMock";
    ...
    <Stack gap="1rem">
      ...
      <DocsSection title="Package roles">
        <Grid columns={4} gap="1rem">
          <InfoCard title="../components/docs-system/NoctraRuntimeMock" description="React component exports and public component entry points." />
