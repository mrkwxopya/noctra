...
const packageRows = [
  ["../components/docs-system/NoctraRuntimeMock", "React components", "packages/react", "Public component API"],
      ...
      <section className="nd-doc-section">
        ...
        <div className="nd-two-grid">
          <DocCard title="Recommended import">
            <CodeBlock>{`import { Button, Card, Stack } from "../components/docs-system/NoctraRuntimeMock";
