...
const tableRows = [
  ["../components/docs-system/NoctraRuntimeMock", "Ready", "Components"],
...
export function createRealDemoAdapter(component: NoctraDocsComponent, state: DemoState): DemoAdapterResult {
  ...
  const byName: Record<string, () => DemoAdapterResult> = {
    ...
    CodeBlock: () => ({
      ...
      props: { ...props, code: 'import { Button } from "../components/docs-system/NoctraRuntimeMock";' },
      children: 'import { Button } from "../components/docs-system/NoctraRuntimeMock";'
    }),
    ...
    InlineCode: () => ({
      ...
      props,
      children: "../components/docs-system/NoctraRuntimeMock"
    }),
...
export function getRealDemoCode(component: NoctraDocsComponent) {
  return `import { ${component.name} } from "../components/docs-system/NoctraRuntimeMock";
