...
const tableRows = [
    { package: "../components/docs-system/NoctraRuntimeMock", status: "Ready", coverage: "Runtime" },
...
export function getInteractiveDemoCode(component: string | DemoComponentLike, state: DemoStateLike = {}) {
    ...
    if (children === false || children === null || children === undefined) {
        return `import { ${componentName} } from "../components/docs-system/NoctraRuntimeMock";
