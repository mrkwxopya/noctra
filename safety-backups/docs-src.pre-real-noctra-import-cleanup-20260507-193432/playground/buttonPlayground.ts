import type { NcDensity, NcRadius, NcSize, NcTone } from "../components/docs-system/NoctraRuntimeMock";
import type { NcButtonVariant } from "../components/docs-system/NoctraRuntimeMock";
