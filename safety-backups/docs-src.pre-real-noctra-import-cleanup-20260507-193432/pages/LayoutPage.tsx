import { Card, Grid, Group, Stack, Divider, Paper, Box, Flex, Spacer } from "../components/docs-system/NoctraRuntimeMock";
...
export function LayoutPage() {
  ...
  Card,
  Divider,
  Spacer } from "../components/docs-system/NoctraRuntimeMock";`}</CodePanel>
      </DocsSection>
