...
import * as NoctraReact from "../components/docs-system/NoctraRuntimeMock";
import {
  NoctraCodeBlock,
...
function getButtonCode(state: ButtonPlaygroundState) {
  ...
  return `import { Button } from "../components/docs-system/NoctraRuntimeMock";
    ...
    <>
      ...
      >
        <NoctraDocsDemo
          ...
          code={`import { Button } from "../components/docs-system/NoctraRuntimeMock";
  ...
  return (
    <NoctraDocsPage
      ...
      links={[
        ...
        { label: "Package", value: "../components/docs-system/NoctraRuntimeMock" },
